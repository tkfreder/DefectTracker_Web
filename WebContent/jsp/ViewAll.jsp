...
<body>
	<div class="container form-group center" style="width: 700px">
		...
		<nav class="navbar navbar-blue">
			...
			<form name="Search_Defect_Form" action="SearchDefect" method="POST">
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<select class="form-control" id="sel2" name="priority" style="width: 200px">
							<option value="">All</option>
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<select class="form-control" id="sel3" name="assignee" style="width: 200px">
		...
		<div class="scrollVertical">
			<TABLE class="table table-bordered table-hover table-condensed table-striped" BORDER="1"
				width="100%"
			>
				<%
			...
			%>
				<TR>
					<TD ALIGN="center"><a href="EditDefect?id=<%=defectList.get(i).getId()%>"><%=defectList.get(i).getId()%></a></TD>
					...
					<TD ALIGN="center"><a href="SendEmail?id=<%=defectList.get(i).getId()%>"
						class="btn btn-default btn-xs button-rounded-high"
